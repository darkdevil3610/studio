...
export const GithubIcon = (p: SVGProps<SVGSVGElement>) => (
  <Icon {...p}><path d="M8 1.5A6.5 6.5 0 0 0 5.9 14.1c.3.1.4-.1.4-.3v-1.1c-1.8.4-2.2-.9-2.2-.9-.3-.8-.7-1-.7-1-.6-.4.1-.4.1-.4.7.1 1 .7 1 .7.6 1 1.6.7 2 .6.1-.5.3-.8.4-1-1.4-.2-3-.7-3-3.2 0-.7.3-1.3.7-1.8-.1-.2-.3-.8.1-1.8 0 0 .6-.2 1.9.7.6-.2 1.2-.3 1.8-.3.6 0 1.2.1 1.8.3 1.3-.9 1.9-.7 1.9-.7.4 1 .2 1.6.1 1.8.4.5.7 1.1.7 1.8 0 2.5-1.6 3-3 3.2.3.2.5.7.5 1.4v2.1c0 .2.1.4.5.3A6.5 6.5 0 0 0 8 1.5Z" /></Icon>
);
